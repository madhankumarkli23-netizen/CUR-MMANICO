...
import { MessageCircle, Calendar, Clock, CalendarCheck } from 'lucide-react';
...
export default function WhatsAppButton() {
  ...
  // WhatsApp URL for general contact
  ...
  return (
    ...
    >
      ...
      {/* Book Appointment Button - Below WhatsApp, Different Color */}
      <div 
        className={`relative transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
      ...
      >
        ...
        >
          {/* Calendar Check Icon - More recognizable for appointments */}
          <CalendarCheck className="w-8 h-8 transition-transform group-hover:rotate-12" />
        </button>
      </div>
