...
const Hero = () => {
    ...
    return (
        <section className="relative min-h-[95vh] w-full overflow-hidden flex items-center pb-24" style={{ minHeight: '-webkit-fill-available', paddingTop: 'clamp(4.5rem, 12vw, 6rem)' }}>
