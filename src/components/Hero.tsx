...
const Hero = () => {
    ...
    return (
        <section className="relative min-h-[95vh] w-full overflow-hidden flex items-center pb-24" style={{ minHeight: '-webkit-fill-available', paddingTop: 'calc(6rem + env(safe-area-inset-top, 0px))' }}>
